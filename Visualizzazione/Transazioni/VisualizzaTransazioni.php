...
<!NAVBAR>
  ...
  exit;
    ...
    if($id!=NULL){
        $Sql= "SELECT * FROM TRANSAZIONI WHERE ID_Cliente='$id';";
     }else{
  ...
  echo("<h2 style=\"background-color:#fe5d00;\">Storico transazioni<p></p>
  ...
  {
  echo("<tr><td>". $Dati['ID_Transazione'] . "</td>");
  echo("<td>".$Dati['Data']."</td>");
  echo("<td>&euro;". $Dati['Ammontare'] . "</td>");
