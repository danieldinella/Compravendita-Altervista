...
<!NAVBAR>
  ...
  $Query= "INSERT INTO TITOLI
  VALUES (NULL,'$tipo','$provincia',NULL,NULL,'$id_c');";

  $Res= mysqli_query($Connessione, $Query); //Eseguire la query
  if(!$Res)
  print("<h2 style=\"background-color:#fe5d00;\">Dichiarazione fallita<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  else
  print("<h2 style=\"background-color:#fe5d00;\">Dichiarazione avvenuta con successo<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  mysqli_close($Connessione); //Chiudere la connessione
  ?>
