...
<!NAVBAR>
  ...
  <!-FORM->
  <?php
  print("<form action=\"InserisciRichiesta3.php?id=$id\" method= \"Post\" style=\"background-color:#fe5d00;\">
  <h2>Invia richiesta</h2>
  <br/>");
  if($_POST['Tipo']=='Acquisto'){
   echo "&nbsp; Budget: &euro;<input type= \"number\" min=\"0.01\" max=\"9999999999999.99\" step=\"0.01\" size= \"15\" name= \"Budget\">
   <br/><br/>";
   echo "&nbsp; Fido: <input type=\"File\" name=\"Fido\" accept=\"image/png, image/jpeg,application/pdf\">";
   echo "<input type=\"hidden\" name=\"Prezzo\" value=\"\">";
   echo "<input type=\"hidden\" value=\"\" name=\"ID_T\">";
  }
  else {
    echo "&nbsp; Prezzo: &euro;<input type= \"number\" min=\"0.01\" max=\"9999999999999.99\" step=\"0.01\" size= \"15\" name= \"Prezzo\"> <br/><br/>";
    echo "&nbsp; ID Titolo: <input type=\"number\" required=\"true\" name=\"ID_T\">";
    echo "<input type=\"hidden\" name=\"Budget\" value=\"\">";
    echo "<input type=\"hidden\" name=\"Fido\" value=\"\">";
  }
  print("<br/><br/>");
  $tipo=$_POST["Tipo"];
