...
<!NAVBAR>
  ...
  <!-FORM->
  <?php
  print("<form action=\"FirmaRichiesta3.php?id=$id\" method= \"Post\" style=\"background-color:#fe5d00;\">
  <h2>Firma richiesta</h2>
  <br/>
    &nbsp; Percentuale: <input type= \"number\" min=\"1\" max=\"15\" step=\"1\" name= \"Percentuale\">%<br/><br/>
    &nbsp; Data: <input type=\"date\" required=\"true\" name=\"Data\"><br/><br/>
    &nbsp; Scadenza: <input type=\"date\" required=\"true\" name=\"Scadenza\">
  <br/><br/>");
  $id_r=$_POST["ID_R"];
  echo "<input type=\"hidden\" name=\"ID_R\" value=$id_r>";
  print("&nbsp; <input type= \"reset\" value= \"Annulla\">
  <input type= \"submit\" value= \"Firma richiesta\">
  <br/><br/><br/><br/><br/><br/>
  </form>");
    ?>
