...
<!--NAVBAR-->
  ...
  $Query= "SELECT ID_Titolo FROM TITOLI WHERE ID_Titolo=$id_t AND ID_Cliente=$id;";
    $Res= mysqli_query($Connessione, $Query);
    $Dati=mysqli_fetch_array($Res);
    if($Dati['ID_Titolo']!=$id_t){
        print("<h2 style=\"background-color:#fe5d00;\">Titolo non disponibile<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
        exit;
        }
        $Query= "INSERT INTO RICHIESTE VALUES (NULL,NULL,NULL,$prezzo,$budget,$fido,NULL,NULL,'$tipo',NULL,'$id',$id_t);";
  $Res= mysqli_query($Connessione, $Query); //Eseguire la query


  if(!$Res)
  print("<h2 style=\"background-color:#fe5d00;\">Invio richiesta V fallito<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  else
  print("<h2 style=\"background-color:#fe5d00;\">Invio richiesta avvenuto con successo<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  }else{
  //Impostare la query
  $Query= "INSERT INTO RICHIESTE VALUES (NULL,NULL,NULL,$prezzo,$budget,$fido,NULL,NULL,'$tipo',NULL,'$id',$id_t);";
  $Res= mysqli_query($Connessione, $Query); //Eseguire la query
  ...
  if(!$Res)
  print("<h2 style=\"background-color:#fe5d00;\">Invio richiesta A fallito<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  else
  print("<h2 style=\"background-color:#fe5d00;\">Invio richiesta avvenuto con successo<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
  }
  mysqli_close($Connessione); //Chiudere la connessione
