...
<!NAVBAR>
  ...
  $Query1="SELECT * FROM CARTE WHERE Numero='$numero' AND Nominativo='$nominativo'
  AND CVC='$cvc' AND Scadenza='$scadenza';";
  $ris=mysqli_query($Connessione,$Query1);
  $numerorighe=mysqli_num_rows($ris);
    if($numerorighe==0){
    print ("<h2 style=\"background-color:#fe5d00;\">Carta inesistente<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
    }
    else{
        if($id_c!=NULL){
      $Query2= "UPDATE CLIENTI SET Patrimonio=Patrimonio+'$patrimonio' WHERE ID_Cliente='$id_c';";
    }else{
        $Query2= "UPDATE SOCIETA SET Patrimonio=Patrimonio+'$patrimonio';";
    }
      $Res= mysqli_query($Connessione, $Query2); //Eseguire la query
      if(!$Res)
      print("<h2 style=\"background-color:#fe5d00;\">Fatturazione fallita<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
      else
      print("<h2 style=\"background-color:#fe5d00;\">Fatturazione avvenuta con successo<br/><br/><br/><br/><br/><br/><br/><br/><br/></h2>");
    }
