...
<!NAVBAR>
  ...
  <!-FORM->
  <?php
  print("<form action=\"InserisciTransazioni3.php?id=$id\" method= \"Post\" style=\"background-color:#fe5d00;\">
  <h2>Proponi una transazione</h2>
  <br/>");
  if($_POST['Tipo']=='Vendita'){
   echo "&nbsp; ID_Titolo: <input type=\"number\" min=\"1\" name=\"ID_T\" size=\"5\" required=\"true\">
  <br/><br/>";
   echo "&nbsp; Offerta: &euro; <input type= \"number\" min=\"0.01\" max=\"9999999999999.99\" step=\"0.01\" size= \"15\" name= \"Ammontare\">
   <br/><br/>";
  }else{
      print("&nbsp; ID_Richiesta: <input type=\"number\" min=\"1\" name=\"ID_R\" size=\"5\" required=\"true\">
  <br/><br/><input type=\"hidden\" name=\"Ammontare\" value=\"\">
  &nbsp; Fido: <input type=\"File\" name=\"Fido\" accept=\"image/png, image/jpeg,application/pdf\"><br/><br/>");
  }
